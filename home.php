...
<main class="main">
    <div class="main__wrapper">
        <div class="ready-to-adopt" style="background-image:url(<?= get_template_directory_uri() . "/assets" . "/img" . "/ready-to-adopt.jpg" ?>); background-size:cover; background-position:center center">
            ...
            <!-- Разбить код на блоки,тоесть будет папка с таким же названием как у страницы,внутри будет файл php
              с названим страницы и буду ещё файлы которые будут представлять собой блоки,сделал блок и 
              вставил в home.php допустим,тоесть будет разбивка страницы на блоки.
              Блоки или компоненты которые используються на нескольких станицах будут храниться в отдельной папке 
              и иметь один файл стилей common.scss 
              Стили компонентов которые используються только на 1 странице будут находиться в стилях этой страницы
              -->
        </div>
    </div>
</main>
